...
metaOutputFDR_OrderbyPval$Mouse_Symbol[c(1:40)]
...
metaOutputFDR_OrderbyPval$Mouse_EntrezGene.ID[c(1:40)]
...
MakeForestPlots(metaOutputFDR_annotated, EntrezIDAsCharacter="75784", species="Mouse") #Cfap299

MakeForestPlots(metaOutputFDR_annotated, EntrezIDAsCharacter="80719", species="Mouse")#Igsf6

MakeForestPlots(metaOutputFDR_annotated, EntrezIDAsCharacter="68603", species="Mouse") #Pmvk
